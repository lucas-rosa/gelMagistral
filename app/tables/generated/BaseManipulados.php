 ...
 * @property string $txt_manipulado
 ...
 */
abstract class BaseManipulados extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('manipulados');
        ...
        $this->hasColumn('txt_manipulado', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             'fixed' => false,
             'unsigned' => false,
