...
class QuemsomosController extends ControllerBase {
     ...
     * 
     */
    public function QuemsomosController($controller, $action, $urlparams) {
    ...
    private function index_action() {
        //Solicita os dados
        $dados_textos = $this->Delegator('ConcreteQuemsomos', 'SelectTextos');
     ...
     * Metodo detalhes
     * 
     * Encaminha para o ConcreteQuemsomos e solicita a acao SelectTextosId pasando
    ...
    private function detalhes() {
        ...
        if ($id !== false && is_numeric($id)) {
            ...
            $dados_lista_comum = $this->Delegator('ConcreteQuemsomos', 'SelectTextosId', array('cod_relacao_idioma' => $id));
