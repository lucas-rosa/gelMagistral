...
/**
 * Classe ListacomumController
 *
 * Esta classe extende ao ControllerBase sendo responsavel
 * por todas as acoes dentro do Listacomum.
 * 
...
class ListacomumController extends ControllerBase {
    ...
    private function index_action() {
        //Solicita os dados
        $dados_textos = $this->Delegator('ConcreteListacomum', 'SelectTextos');
     ...
     * Metodo detalhes
     * 
     * Encaminha para o ConcreteListacomum e solicita a acao SelectTextosId pasando
    ...
    private function detalhes() {
        ...
        if ($id !== false && is_numeric($id)) {
            ...
            $dados_lista_comum = $this->Delegator('ConcreteListacomum', 'SelectTextosId', array('cod_relacao_idioma' => $id));
