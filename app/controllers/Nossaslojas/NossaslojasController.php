...
class NossaslojasController extends ControllerBase {
     ...
     * 
     */
    public function NossaslojasController($controller, $action, $urlparams) {
    ...
    private function index_action() {
        //Solicita os dados
        $dados_textos = $this->Delegator('ConcreteNossaslojas', 'SelectTextos');
     ...
     * Metodo detalhes
     * 
     * Encaminha para o ConcreteNossaslojas e solicita a acao SelectTextosId pasando
    ...
    private function detalhes() {
        ...
        if ($id !== false && is_numeric($id)) {
            ...
            $dados_lista_comum = $this->Delegator('ConcreteNossaslojas', 'SelectTextosId', array('cod_relacao_idioma' => $id));
