...
/**
 * Classe TrabalheconoscoController
 *
 * Esta classe extende ao ControllerBase sendo responsavel
 * por todas as acoes dentro do Trabalheconosco.
 * 
...
class TrabalheconoscoController extends ControllerBase {
    ...
    private function index_action() {
        //Solicita os dados
        $dados_textos = $this->Delegator('ConcreteTrabalheconosco', 'SelectTextos');
     ...
     * Metodo detalhes
     * 
     * Encaminha para o ConcreteTrabalheconosco e solicita a acao SelectTextosId pasando
    ...
    private function detalhes() {
        ...
        if ($id !== false && is_numeric($id)) {
            ...
            $dados_lista_comum = $this->Delegator('ConcreteTrabalheconosco', 'SelectTextosId', array('cod_relacao_idioma' => $id));
