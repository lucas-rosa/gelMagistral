<?php /* Smarty version Smarty-3.1.1, created on 2013-07-25 17:07:44
         compiled from "app/view/templates/Trabalheconosco/index.php" */ ?>
<?php /*%%SmartyHeaderCode:14427331451f18591386a65-91886510%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9eda89f20be1c9dccf902a8ea905bddbd5180274' => 
    array (
      0 => 'app/view/templates/Trabalheconosco/index.php',
      1 => 1374782499,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14427331451f18591386a65-91886510',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51f185914723d',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51f185914723d')) {function content_51f185914723d($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (($_smarty_tpl->tpl_vars['HEAD']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
  ...
  <div class="vejamais-side">
    ...
    <div class="quemsomos-content">
        <div class="description">
            ...
            <p>Entre em contato pelo formul&aacute;rio abaixo, anexe o seu curriculo e se cadastre em nossa base de dados.</p>
        </div>
        ...
        <form class="form-pedido">
            <div class="form-pedido-border">
                ...
                <div class="left">
                    ...
                    <input type="text" name="" value="Trabalhe Conosco" onfocus="this.value='';" onblur="this.value=this.value==''?'Trabalhe Conosco':this.value;" />
                    <input type="file" name="" />
                </div>
                <div class="right message f-left">
                     <textarea onfocus="this.value='';" onblur="this.value=this.value==''?'Mensagem':this.value;">Mensagem</textarea>
