...
function Datepicker() {
	...
	this.regional = {
		'': { // US/English
			...
			prevStatus: 'Ver o mês anterior', // Status text for the previous month command
			prevJumpText: '&lt;&lt;', // Text for the previous year command
			prevJumpStatus: 'Ver o ano anterior', // Status text for the previous year command
			nextText: 'Próx&gt;', // Text for the next month command
			nextStatus: 'Ver o próximo mês', // Status text for the next month command
			nextJumpText: '&gt;&gt;', // Text for the next year command
			nextJumpStatus: 'Ver o próximo ano', // Status text for the next year command
			currentText: 'Atual', // Text for the current month command
			currentStatus: 'Ver mês atual', // Status text for the current month command
			todayText: 'Hoje', // Text for the today's month command
			todayStatus: 'Ver mês atual', // Status text for the today's month command
			clearText: 'Limpar', // Text for the clear command
			clearStatus: 'Limpar todas as datas', // Status text for the clear command
			closeText: 'Fechar', // Text for the close command
			closeStatus: 'Fechar calendário', // Status text for the close command
			yearStatus: 'Mudar o ano', // Status text for year selection
			monthStatus: 'Mudar o mês', // Status text for month selection
			weekText: 'Sm', // Text for week of the year column header
			weekStatus: 'Semana do ano', // Status text for week of the year column header
			dayStatus: 'Selecione DD, M d, yyyy', // Status text for selectable days
			defaultStatus: 'Selecione a data', // Status text shown by default
