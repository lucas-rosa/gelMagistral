...
/**
 * Classe DicasController
 *
 * Esta classe extende ao ControllerBase sendo responsavel
 * por todas as acoes dentro do Dicas
 * 
 * @package admin\app\controllers\Dicas\DicasController
 * @author  Linea Comunicacao
 * @link    http://www.agencialinea.com.br
 */
class DicasController extends ControllerBase
{
    /**
     * global $altura_crop
     * 
     ...
     */
    public function DicasController($controller, $action, $urlparams)
    {
     ...
     * Metodo index_action
     * 
     * O metodo index_action faz as chamadas iniciais ao entrar em Dicas
     * mandando para o model ConcreteDicas chamando o metodo SelectConteudos
    ...
    private function index_action()
    {
        ...
        $dados_dicas = $this->Delegator('ConcreteDicas', 'SelectConteudo');
     ...
     * solicita a inclusao chamando o model ConcreteDicas e o
    ...
    private function incluir()
    {
        ...
        if($_SERVER['REQUEST_METHOD'] == "POST")
        {
            ...
            $resultado = $this->Delegator('ConcreteDicas', 'IncluirDica', $this->getPost());
        }
        else
        {
            //Busca os idiomas
     ...
     * solicita o cadastro do registro mandando para o model ConcreteDicas chamando
     * o metodo EditaDica. Caso os dados nao sejam enviados por POST chama o model
     * ConcreteDicas e o metodo SelectDicaRelacaoIdEditar passando o id por parametro e armazena 
     ...
     * solicita a exclusao do registro mandando para o model ConcreteDicas chamando
     * o metodo ExcluirDica.
     * 
     */
    private function excluir()
    {
        ...
        {
            //Exclui os dados
            $this->Delegator('ConcreteDicas', 'ExcluirDica', $this->getParam());
        }
    }
     ...
     * Metodo detalhes
     * 
     * O metodo detalhes chama o model ConcreteDicas chamando o metodo SelectDicaRelacaoId.
    ...
    private function detalhes()
    {
        ...
        if($this->getParam('cod_id') !== false && is_numeric($this->getParam('cod_id')))
        {
            ...
            $dados_dica = $this->Delegator('ConcreteDicas', 'SelectDicaRelacaoId', $this->getParam());
   ...
   /**
     * Metodo getIdiomas
     * 
     * O metodo getIdiomas chama o model ConcreteDicas chamando o metodo getIdiomas.
     * 
     */
    private function getIdiomas()
    {
        //Solicita os dados dos idiomas
        $dados = $this->Delegator('ConcreteDicas', 'getIdiomas');
     ...
     * Caso seja setado o campo $_POST['save_thumb_inc'] chama o model ConcreteDicas e o metodo  
     * salvarCropadaInc passando o diretorio e o tamanho maximo em um array.
      * 
     * Caso seja setado o campo $_POST['a'] chama o model ConcreteDicas e o metodo
     ...
     * $_SESSION['randomico']. $_SESSION['user_file_ext'] recebe vazio e acaba com a $_SESSION['randomico'].
      *  
     * Caso nao se aplique nenhuma das questoes acima evia para o model ConcreteDicas chamando o metodo
    ...
    public function imagem()
    {
        if(isset($_POST['save_thumb_inc']))
        {
            ...
            $this->Delegator('ConcreteDicas', 'salvarCropadaInc', array('diretorio' => $this->diretorio, 'tamanho_maximo' => $this->tamanho_maximo));
        }
        elseif(isset($_POST['a']))
        {
            //Deleta a imagem na inclusao
            $this->Delegator('ConcreteDicas', 'deletarImagemInc', array('altura_crop' => $this->altura_crop, 'largura_crop' => $this->largura_crop, 'diretorio' => $this->diretorio, 'tamanho_maximo' => $this->tamanho_maximo, 'largura_maxima' => $this->largura_maxima));
        }
     ...
     * 
     * Caso seja setado o campo $_POST['save_thumb_edt'] chama o model ConcreteDicas e o metodo  
     * salvarCropadaEdt passando o diretorio e o tamanho maximo em um array.
     * 
     * Caso seja setado o campo $_POST['inclusao_banco'] chama o model ConcreteDicas e o metodo
     * incluirImagemBancoEdicao.
     * 
     * Caso seja setado o campo $_POST['deletar'] chama o model ConcreteDicas e o metodo
     * deletimg.
     * 
     * Caso seja setado o campo $_POST['cancelar_upload'] chama o model ConcreteDicas e o metodo
     * cancelarUpload.
     * 
     * Caso seja setado o campo $_POST['salvar_recropagem'] chama o model ConcreteDicas e o metodo
     * salvarRecropagem.
     *
     * Caso seja setado o campo $_POST['reiniciar'] e seja setado o campo $_SESSION['user_file_ext'] ou
     * $_SESSION['randomico']. $_SESSION['user_file_ext'] recebe vazio e acaba com a $_SESSION['randomico']. 
