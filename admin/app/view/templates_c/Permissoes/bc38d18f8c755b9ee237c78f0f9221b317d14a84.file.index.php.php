...
<?php /*%%SmartyHeaderCode:62574920050f42e8d4f3a19-63399068%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '62574920050f42e8d4f3a19-63399068',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_50f42e8d8bd0c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_50f42e8d8bd0c')) {function content_50f42e8d8bd0c($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
logado" title="" class="dashboard no-submenu current">Painel de Controle</a></li>
				...
				<li <?php if (in_array($_smarty_tpl->tpl_vars['CONTROLLER_ATUAL']->value,array('Cadastro','Contatos','Noticias','Textos','Textoslayout','Faleconosco','Emailformulario','Download'))){?> class="current" <?php }?> ><a title="Conte&uacute;dos do site" class="projects">Conte&uacute;dos do site</a>
					<ul>
...
download" title="Download">Download</a></li>
	                    <?php }?>
					</ul>
				</li>
