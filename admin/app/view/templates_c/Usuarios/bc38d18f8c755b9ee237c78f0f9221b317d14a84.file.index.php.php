...
<?php /*%%SmartyHeaderCode:172802620650ca30bd5ddf97-24475547%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '172802620650ca30bd5ddf97-24475547',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_50ca30bd989dc',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_50ca30bd989dc')) {function content_50ca30bd989dc($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
logado" title="" class="dashboard no-submenu current">Painel de Controle</a></li>
				...
				<li <?php if (in_array($_smarty_tpl->tpl_vars['CONTROLLER_ATUAL']->value,array('Cadastro','Contatos','Noticias','Textos','Textoslayout','Faleconosco','Emailformulario'))){?> class="current" <?php }?> ><a title="Conte&uacute;dos do site" class="projects">Conte&uacute;dos do site</a>
					<ul>
